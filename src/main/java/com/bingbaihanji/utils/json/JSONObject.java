...
public class JSONObject {
    ...
    public JSONObject() {
        ...
        // 使用HashMap是为了确保元素是无序的
        // 该规范。
        // JSON倾向于是一种允许容器的可移植传输格式
        // 实现重新排列它们的项以获得更快的元素
        // 基于关联访问的检索。
        // 因此，实现不能依赖于项的顺序。
     ...
     * are ignored.
     * 从另一个JSONObject的子集构造一个JSONObject
     *
     ...
     * <p>
     * 从对象构造JSONObject，使用反射查找
     * 公众的成员。产生的JSONObject的键将是来自的字符串
     * names数组，值将是与之关联的字段值
     * 对象中的键。如果一个键没有找到或不可见，那么它
     * 不会被复制到新的JSONObject中。
     *
     ...
     * 从一个ResourceBundle构造一个JSONObject。
     *
    ...
    static final Writer writeValue(Writer writer, Object value, int indentFactor, int indent) throws JSONException, IOException {
        if (value == null || value.equals(null)) {
            ...
            try {
                ...
                @SuppressWarnings("unused") BigDecimal testNum = new BigDecimal(numberAsString);
